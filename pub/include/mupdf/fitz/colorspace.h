...
/*
	fz_device_gray: Get colorspace representing device specific mono.
*/
fz_colorspace *fz_device_mono(fz_context *ctx);
...
/*
	fz_set_device_mono: Set colorspace representing device specific mono.
*/
void fz_set_device_mono(fz_context *ctx, fz_colorspace *cs);
